...
```{r, tidy.opts=TRUE, message=FALSE, warning=FALSE}
...
```{r, include=FALSE}
#encoding to csv not sorted yet
#dataframeNamecsv <- str_c("archive/", Datestamp) %>%
#  str_replace_all(" ", "") %>%
#  str_c("drugs.csv")
#write.csv(totaldataframe, dataframeNamecsv)
#write.csv(totaldataframe, "drugs.csv")
